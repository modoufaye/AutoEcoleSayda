        ...
        <div className="flex items-center justify-between h-16">
          ...
          <a href="#accueil" className="flex items-center gap-2 no-underline">
            ...
            <div className="leading-tight">
              <div className="font-bold text-[#1e3a5f] text-sm sm:text-base">Auto-École Excellence</div>
            </div>
          </a>
    ...
    <section className="py-20 bg-[#d4a017]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-amber-100 text-lg mb-8">
          Rejoignez l'Auto-École Excellence et bénéficiez d'un suivi personnalisé jusqu'à l'obtention de votre permis.
        </p>
    ...
    <footer id="contact" className="bg-[#142a47] text-white">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-lg">Auto-École Excellence</span>
            </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-blue-300">
          <span>© 2026 Auto-École Excellence. Tous droits réservés.</span>
